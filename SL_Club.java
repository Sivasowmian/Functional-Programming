...
public class SL_Club implements Comparable<SL_Club> {
  ...
  public SL_Club(int position, String club, int played, int won, int drawn,
...
public String toString() {
  ...
  public int compareTo(SL_Club c) {
